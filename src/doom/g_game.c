...
{ 
    ...
    if ((!doom_plus_limits && vanilla_savegame_limit && ftell(save_stream) > SAVEGAMESIZE / DOOM_PLUS_SAVEGAMESIZE_FACTOR)
        || (doom_plus_limits && vanilla_savegame_limit && ftell(save_stream) > SAVEGAMESIZE))
    {
